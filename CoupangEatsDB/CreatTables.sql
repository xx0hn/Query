...
ALTER TABLE menu ADD `cost` INT NOT NULL COMMENT'금액';
ALTER TABLE restaurant ADD `delTime` INT NOT NULL COMMENT'배달시간';
ALTER TABLE orders ADD `restaurantId` INT NOT NULL COMMENT'식당id';
